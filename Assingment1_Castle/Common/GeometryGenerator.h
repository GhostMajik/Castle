...
public:
	...
	MeshData CreateHexagonPrism(float width, float height, float depth, uint32 numSubdivisions);

	MeshData CreateHexagonPyramid(float width, float height, float depth, uint32 numSubdivisions);
